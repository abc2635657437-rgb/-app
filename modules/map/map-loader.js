(function () {
  if ('serviceWorker' in navigator && location.protocol !== 'file:') navigator.serviceWorker.register('/sw.js?v=4', { updateViaCache: 'none' }).then(registration => registration.update()).catch(() => {});
