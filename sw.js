const CACHE = 'travel-world-offline-v17-language-setting';
const ASSETS = ['/modules/chat/chat-web.js?v=3', '/modules/theme/ukiyoe.js?v=9', '/modules/theme/ukiyoe.css?v=9', '/assets/workbuddy-globe.html', '/', '/index.html', '/modules/data/landmarks.json', '/modules/data/routes.json?v=2', '/modules/auth/auth-web.js?v=8', '/modules/community/post-ui.js?v=1', '/modules/community/home-api.js?v=8', '/modules/routes/route-web.js?v=1', '/modules/map/landmark-gallery.js?v=2', '/modules/discover/discover-web.js?v=6', '/modules/ai/ai-planner.js?v=6', '/modules/map/map-web.js?v=6', '/modules/map/map-actions.js?v=5', '/modules/i18n/i18n.js?v=3', '/modules/navigation/global-back.js?v=1', '/modules/buddies/buddy-web.js?v=6', '/modules/profile/profile-web.js?v=9'];
