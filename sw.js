const CACHE = 'travel-world-offline-v12-workbuddy-globe';
const ASSETS = ['/modules/chat/chat-web.js?v=3', '/modules/theme/ukiyoe.js?v=9', '/modules/theme/ukiyoe.css?v=8', '/assets/workbuddy-globe.html', '/', '/index.html', '/modules/data/landmarks.json', '/modules/data/routes.json', '/modules/auth/auth-web.js?v=8', '/modules/community/post-ui.js?v=1', '/modules/community/home-api.js?v=8', '/modules/routes/route-web.js?v=1', '/modules/map/landmark-gallery.js?v=1', '/modules/ai/ai-planner.js?v=5', '/modules/map/map-web.js?v=5', '/modules/map/map-actions.js?v=5', '/modules/buddies/buddy-web.js?v=6', '/modules/profile/profile-web.js?v=8'];
